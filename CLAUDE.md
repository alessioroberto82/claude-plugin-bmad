...
**Workflow order**: arch → [security] (opt-in; P0 blocks impl when included) → impl → qa (REJECT loops to impl) → commit → push → PR → code-review. Never suggest `/bmad-code-review` before a PR exists.
